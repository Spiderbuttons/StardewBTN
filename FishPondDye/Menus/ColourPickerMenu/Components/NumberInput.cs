...
public class NumberInput : TextBox
{
    ...
    public bool isHoldingModifierKey()
    {
        return ModEntry.ModHelper.Input.IsDown(SButton.LeftShift) || ModEntry.ModHelper.Input.IsDown(SButton.RightShift) ||
               ModEntry.ModHelper.Input.IsDown(SButton.LeftShoulder) || ModEntry.ModHelper.Input.IsDown(SButton.RightShoulder);
    }
